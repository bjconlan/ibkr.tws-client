...
import io.github.bjc.ibkr.model.AccountValue;
import io.github.bjc.ibkr.model.Bar;
import io.github.bjc.ibkr.model.PortfolioValue;
import io.github.bjc.ibkr.model.TickAttrib;
import io.github.bjc.ibkr.proto.AccountDataEndProto;
import io.github.bjc.ibkr.proto.AccountUpdateTimeProto;
import io.github.bjc.ibkr.proto.AccountValueProto;
import io.github.bjc.ibkr.proto.CommissionAndFeesReportProto;
import io.github.bjc.ibkr.proto.ContractDataEndProto;
import io.github.bjc.ibkr.proto.ContractDataProto;
import io.github.bjc.ibkr.proto.CurrentTimeProto;
import io.github.bjc.ibkr.proto.ErrorMessageProto;
import io.github.bjc.ibkr.proto.ExecutionDetailsEndProto;
import io.github.bjc.ibkr.proto.ExecutionDetailsProto;
import io.github.bjc.ibkr.proto.HistoricalDataBarProto;
import io.github.bjc.ibkr.proto.HistoricalDataEndProto;
import io.github.bjc.ibkr.proto.HistoricalDataProto;
import io.github.bjc.ibkr.proto.ManagedAccountsProto;
import io.github.bjc.ibkr.proto.MarketDataTypeProto;
import io.github.bjc.ibkr.proto.NextValidIdProto;
import io.github.bjc.ibkr.proto.OpenOrderProto;
import io.github.bjc.ibkr.proto.OrderStatusProto;
import io.github.bjc.ibkr.proto.PortfolioValueProto;
import io.github.bjc.ibkr.proto.PositionEndProto;
import io.github.bjc.ibkr.proto.PositionProto;
import io.github.bjc.ibkr.proto.TickGenericProto;
import io.github.bjc.ibkr.proto.TickOptionComputationProto;
import io.github.bjc.ibkr.proto.TickPriceProto;
import io.github.bjc.ibkr.proto.TickReqParamsProto;
import io.github.bjc.ibkr.proto.TickSizeProto;
import io.github.bjc.ibkr.proto.TickSnapshotEndProto;
import io.github.bjc.ibkr.proto.TickStringProto;
...
public final class Decoder {
    ...
    private IbEvent orderStatus(byte[] payload) throws InvalidProtocolBufferException {
        ...
        return new IbEvent.OrderStatus(new io.github.bjc.ibkr.model.OrderStatusData(
