...
/**
 * Base ids of the outbound requests. Values are stable protocol constants from the TWS API;
 * the protobuf wire id is {@code id + 200}.
 *
 * <p>Mirrors the upstream {@code OutgoingMsgId} enum. The payload for each is the generated
 * protobuf message; {@link Encoder#encode(OutgoingId, com.google.protobuf.MessageLite)} frames
 * it without the client needing a bespoke method per request.
 */
