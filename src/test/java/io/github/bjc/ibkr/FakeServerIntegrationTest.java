...
import io.github.bjc.ibkr.protocol.IncomingId;
import io.github.bjc.ibkr.protocol.OutgoingId;
...
class FakeServerIntegrationTest {
    ...
    void snapshotMarketDataProducesTicks() throws Exception {
        ...
        try (ServerSocket server = new ServerSocket(0)) {
            ...
            try (TwsClient client = new TwsClient(config, events::add)) {
                client.connect();
                client.reqMktData(42, io.github.bjc.ibkr.model.Contract.stock("AAPL"), "", true, false);
